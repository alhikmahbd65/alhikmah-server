            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout: fixed;">
                <tr>
                    <td style="text-align: center;">
                        <img src="${config.mainLogo}" width="200" height="100" alt="" style="vertical-align: middle; margin-right: -15px; height:auto;"> <br> 
                    </td>
                </tr>
            </table>
          ...
          <div class="container">
              <div class="email-box">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout: fixed;">
                      <tr>
                          <td style="text-align: center;">
                              <img src="${config.mainLogo}" width="200" height="100" alt="" style="vertical-align: middle; margin-right: -15px; height:auto;"> 
