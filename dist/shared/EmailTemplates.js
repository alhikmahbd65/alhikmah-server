        ...
        <div class="email-box">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout: fixed;">
                <tr>
                    <td style="text-align: center;">
                        <img src="${config_1.default.mainLogo}" width="200" height="100" alt="" style="vertical-align: middle; margin-right: -15px; height:auto;"> <br> 
                    </td>
                </tr>
            </table>
            ...
            <div class="email-box-content">
                ...
                <p class="end">
                    ...
                    If you face any issues, please contact us at support@hikmahlibrary.com
                </p>
                <hr>
                ...
                <p class="end">Copyright &copy; 2024 hikmahlibrary.</p>
            </div>
        </div>
    </div>
</body>
          ...
          <div class="container">
              <div class="email-box">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout: fixed;">
                      <tr>
                          <td style="text-align: center;">
                              <img src="${config_1.default.mainLogo}" width="200" height="100" alt="" style="vertical-align: middle; margin-right: -15px; height:auto;"> 
